...
/**
    BUTTON LAYOUTS
**/
if( !function_exists('awpba_framework_get_button_layouts') ) {
    function awpba_framework_get_button_layouts() {
        return array(
...
/**
    HOVER EFFECTS
**/
if( !function_exists('awpba_framework_get_hover_effects') ) {
    function awpba_framework_get_hover_effects() {
        return array(
...
/**
    ALLOWED HTML TAGS
**/
if( !function_exists('awpba_framework_allowed_tags') ) {
    function awpba_framework_allowed_tags() {
